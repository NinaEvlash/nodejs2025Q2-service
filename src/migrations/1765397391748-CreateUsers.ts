...
export class CreateUsers1765397391748 implements MigrationInterface {
    name = 'CreateUsers1765397391748'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "favorite" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "trackId" character varying, "albumId" character varying, "artistId" character varying, CONSTRAINT "PK_495675cec4fb09666704e4f610f" PRIMARY KEY ("id"))`);
